public class NuevoHilo implements Runnable{
  ...
  public void run() {
    ...
    try {
    	...
    	if(met==1)System.out.println("La suma del vector es:" + suma);
    	if(met==2)System.out.println("La suma de los cuadrados del vector es:" + cuad);
    	if(met==3)System.out.println("La media del vector es:" + med);
